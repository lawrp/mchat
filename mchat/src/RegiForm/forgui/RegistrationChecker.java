...
public class RegistrationChecker {
	...
	void buildChecker() {
		...
		SpecialCharacterCheck spcChk = new SpecialCharacterCheck(
				"Password should contain at least one special charater", this);
		upChk.nextCheck = spcChk;
		NumericCharacterCheck numChk = new NumericCharacterCheck(
				"Password should contain at least one numeric charater", this);
